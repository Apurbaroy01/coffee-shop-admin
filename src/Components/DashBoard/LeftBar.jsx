    ...
    return (
        <div className="flex flex-col gap-3 mb-4 w-full  **:p-2 text-center ">
            <div className="divider">
                <h2 className=" font-bold text-center text-gray-500" id="font">Coffee Section</h2>
            </div>
            ...
            <div className="divider">
                <h2 className=" font-bold text-center text-gray-500" id="font">Oder Section</h2>
            </div>
            <NavLink className="btn rounded-2xl" to="/DashBoard/odderscoffee">Odders Coffee</NavLink>
            <div className="divider">
                <h2 className=" font-bold text-center text-gray-500 " id="font">Login Section</h2>
            </div>
